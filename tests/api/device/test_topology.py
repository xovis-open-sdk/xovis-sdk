...
async def test_get_ms_graph_top_down_resolution(respx_mock):
    ...
    respx_mock.get("http://192.168.1.100:80/api/v5/discover/localnetwork").mock(return_value=Response(200, json=discovery_payload))

    respx_mock.get("http://192.168.1.100:80/api/v5/multisensors/status").mock(return_value=Response(404, json={}))
